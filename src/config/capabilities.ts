...
export const centralCapabilities = {
  ...
  schoolUsersRead: true,
  schoolUsersCreate: true,
  schoolUsersUpdate: true,
  schoolUsersEnableDisable: true,
  schoolUsersResetPassword: true,
  schoolRbacRolesRead: true,
  schoolRbacPermissionsRead: true,
  schoolRbacAssignRole: true,
  schoolRbacRemoveRole: true,
  schoolRbacGrantPermission: true,
  schoolRbacRevokePermission: true,
  schoolRbacViewEffectivePermissions: true,
  schoolUserActivityRead: true,
  schoolUserAuditRead: true,
  ticketsRead: true,
  ticketsDetail: true,
  ticketsAssign: true,
  ticketsClose: true,
