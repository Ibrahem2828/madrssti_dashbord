...
| Assign roles | POST | `/api/gateway/school/admin/users/{id}/roles` | `/api/v1/admin/users/{id}/roles` | `ADMIN_RBAC_ASSIGN_ROLE` | `school.users` | `role_ids` JSON | mutation ack | normalized null result | Implemented |
